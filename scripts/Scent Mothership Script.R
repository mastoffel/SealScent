...
scent_abundance <- as.data.frame(t(read.csv(paste("C:\\Users\\Martin\\Studium\\",
                                ...
                                "data\\csv_files\\scent abundance nobeach.csv", 
                                sep = ""), row.names=1)))
...
relatednessold <- read.csv(paste("C:\\Users\\Martin\\Studium\\",
                              "MSc.Behaviour\\Research\\Seal Scent\\",
                              "R code\\data\\csv_files\\",
                              "relatedness_41loci.csv", sep = ""),
                               row.names=1)
...
allsubsets <- subset_all(subset, beach, scent_abundance,scent_diversity,
